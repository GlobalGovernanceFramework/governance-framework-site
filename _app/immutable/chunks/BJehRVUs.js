import"./NZTpNUN0.js";import"./C_coPdhj.js";import{t as ai,s as n,f as ri,O as e,k as si,c as i,v as o,C as li}from"./DudyAaNe.js";const ci={title:"Appendix E - Reference Materials",section:"appendix-e-reference"},{title:mi,section:hi}=ci;var di=ai('<h1>Appendix E - Reference Materials</h1> <p><strong>In this appendix:</strong></p> <ul><li><a href="#value-phrase-glossary">Value Phrase Glossary</a></li> <li><a href="#practitioner-selection-criteria">Practitioner Selection Criteria</a></li> <li><a href="#academic-bibliography">Academic Bibliography</a></li> <li><a href="#integration-protocol-specifications">Integration Protocol Specifications</a></li> <li><a href="#legal-policy-references">Legal and Policy Framework References</a></li> <li><a href="#cultural-authority-contacts">Cultural Authority Contact Protocols</a></li> <li><a href="#emergency-response-resources">Emergency Response Resources</a></li></ul> <p><strong>Estimated Reading Time</strong>: 25 minutes</p> <p><strong>Purpose</strong>: Provide comprehensive reference materials supporting Peace & Conflict Resolution Framework implementation, including multilingual terminology, academic foundations, legal frameworks, and emergency protocols while maintaining cultural sovereignty and Traditional Knowledge protection.</p> <p><strong>Cultural Attribution Principle</strong>: All cultural terminology and Traditional Knowledge included with explicit permission from cultural authorities and appropriate attribution to originating communities.</p> <h2><a id="value-phrase-glossary"></a>Value Phrase Glossary</h2> <h3>Universal Framework Terminology</h3> <h4><strong>Core Values Spectrum (Spiral Dynamics Integration)</strong></h4> <p><strong>Purple 🟣 - Tradition/Community/Sacred</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Red 🔴 - Power/Survival/Assertion</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Blue ⚖️ - Order/Justice/Fairness</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Orange 🟠 - Progress/Innovation/Success</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Green 💚 - Inclusion/Community/Compassion</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Yellow 🟡 - Systems/Integration/Complexity</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Turquoise 🌐 - Holistic/Ecological/Spiritual</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Coral 🪸 - Paradigm Shift/Transformation/Evolution</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Clear ✨ - Unity/Oneness/Integration</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Cultural Framework Terminology</h3> <h4><strong>Ubuntu Framework (Southern Africa)</strong></h4> <p><em>With permission from Ubuntu practitioners and traditional authorities</em></p> <p><strong>Ubuntu Core Concepts</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Ubuntu Mediation Terminology</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Sulh Framework (Middle East/Islamic Contexts)</strong></h4> <p><em>With permission from Islamic scholars and traditional community leaders</em></p> <p><strong>Islamic Core Concepts</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Islamic Mediation Terminology</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Dharma Framework (South Asian Contexts)</strong></h4> <p><em>With permission from diverse South Asian spiritual teachers and social reformers</em></p> <p><strong>Sanskrit/Hindi Core Concepts</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Sanskrit/Hindi Mediation Terminology</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Indigenous Frameworks (Various Traditions)</strong></h4> <p><em>Always adapted with specific Indigenous community guidance and FPIC 2.0 consent</em></p> <p><strong>Seven Generations Framework Example</strong> <em>(Haudenosaunee principles - used only with community permission)</em>:</p> <pre class="language-undefined"><!></pre> <p><strong>General Indigenous Terminology</strong> <em>(community-specific terms vary)</em>:</p> <pre class="language-undefined"><!></pre> <h3>Multi-Phase Implementation Terminology</h3> <h4><strong>Phase 1: Foundational Security & Autonomy</strong></h4> <p><strong>Cross-Cultural Application Phrases</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Phase 2: Collective Integration & Governance</strong></h4> <p><strong>Cross-Cultural Integration Phrases</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Phase 3: Emergent Partnership & Ownership</strong></h4> <p><strong>Cross-Cultural Transformation Phrases</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="practitioner-selection-criteria"></a>Practitioner Selection Criteria</h2> <h3>Universal Practitioner Standards</h3> <h4><strong>Foundational Requirements (All Certification Levels)</strong></h4> <p><strong>Cultural Competency Prerequisites</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Ethical Standards Compliance</strong>:</p> <ul><li><strong>Anti-Oppression Commitment</strong>: Active challenge to racism, colonialism, and systemic oppression</li> <li><strong>Cultural Appropriation Prevention</strong>: Clear understanding and prevention of Traditional Knowledge extraction</li> <li><strong>Power Dynamic Awareness</strong>: Recognition and mitigation of privilege and power imbalances</li> <li><strong>Community Accountability</strong>: Willingness to be held accountable by cultural authorities and communities</li></ul> <h4><strong>Field Guide Level (40 hours) - 50% Elected, 50% Nominated</strong></h4> <p><strong>Election Process Requirements</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Field Guide Competency Requirements</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Integration Specialist Level (80 hours) - Peer Selection with Cultural Authority Approval</strong></h4> <p><strong>Selection Process</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Integration Specialist Competencies</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Visionary Steward Level (120 hours) - Traditional Authority Selection</strong></h4> <p><strong>Selection Process</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Visionary Steward Competencies</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Cultural Authority Integration</h3> <h4><strong>Traditional Knowledge Keeper Requirements</strong></h4> <p><strong>Indigenous Practitioner Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>External Practitioner Cultural Authority Accountability</strong></h4> <p><strong>Accountability Relationship Requirements</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Continuing Education and Professional Development</h3> <h4><strong>Annual Training Requirements (10 hours minimum)</strong></h4> <p><strong>Framework Evolution Updates</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Training Source Requirements</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Specialization Certifications (20 hours each)</strong></h4> <p><strong>Environmental Conflict Specialization</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Spiritual/Interfaith Specialization</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Digital/Cyber Specialization</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="academic-bibliography"></a>Academic Bibliography</h2> <h3>Foundational Theoretical Works</h3> <h4><strong>Spiral Dynamics and Values-Based Conflict Resolution</strong></h4> <p><strong>Core Theoretical Foundation</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Conflict Resolution and Mediation Theory</strong></h4> <p><strong>Principled Negotiation and Interest-Based Mediation</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Traditional Knowledge and Indigenous Conflict Resolution</strong></h4> <p><strong>Indigenous Justice and Traditional Knowledge Systems</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Cultural Framework Scholarship</h3> <h4><strong>Ubuntu Philosophy and Southern African Conflict Resolution</strong></h4> <p><strong>Ubuntu Theory and Practice</strong> <em>(With permission from Ubuntu scholars and traditional authorities)</em>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Islamic Conflict Resolution and Sulh Tradition</strong></h4> <p><strong>Islamic Mediation and Justice Systems</strong> <em>(With permission from Islamic scholars)</em>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Dharmic Traditions and South Asian Conflict Resolution</strong></h4> <p><strong>Hindu, Buddhist, and Jain Peace Philosophies</strong> <em>(With permission from traditional authorities)</em>:</p> <pre class="language-undefined"><!></pre> <h3>Trauma-Informed and Somatic Approaches</h3> <h4><strong>Trauma and Healing in Conflict Resolution</strong></h4> <p><strong>Somatic and Body-Based Healing Approaches</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Historical and Intergenerational Trauma</strong></h4> <p><strong>Collective Trauma and Community Healing</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Decolonization and Anti-Oppression Theory</h3> <h4><strong>Decolonizing Methodologies and Research</strong></h4> <p><strong>Community-Controlled Research and Knowledge Production</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Indigenous Sovereignty and Self-Determination</strong></h4> <p><strong>Indigenous Rights and Traditional Governance</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Systems Theory and Complexity Science</h3> <h4><strong>Complex Systems and Adaptive Management</strong></h4> <p><strong>Systems Thinking and Network Theory</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Technology Ethics and Digital Governance</h3> <h4><strong>AI Ethics and Algorithmic Accountability</strong></h4> <p><strong>Responsible AI Development and Community Control</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Indigenous Data Sovereignty and Digital Rights</strong></h4> <p><strong>Community-Controlled Data and Technology Governance</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="integration-protocol-specifications"></a>Integration Protocol Specifications</h2> <h3>Golden Triangle Framework Coordination</h3> <h4><strong>Treaty for Our Only Home Integration Protocols</strong></h4> <p><strong>UNSC Override Coordination Standards</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Global Enforcement Mechanism Coordination</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>Global Commons Fund Integration</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Indigenous Framework Integration Protocols</strong></h4> <p><strong>Earth Council Coordination Standards</strong>:</p> <pre class="language-undefined"><!></pre> <p><strong>BAZ Implementation Coordination</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Meta-Governance Framework Integration Protocols</strong></h4> <p><strong>Policy Coherence Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Justice System Integration Protocols</h3> <h4><strong>Digital Justice Tribunal Coordination</strong></h4> <p><strong>Peace Process Escalation Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Truth and Reconciliation Integration</strong></h4> <p><strong>Community-Led Truth Process Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="legal-policy-references"></a>Legal and Policy Framework References</h2> <h3>International Indigenous Rights Framework</h3> <h4><strong>UN Declaration on the Rights of Indigenous Peoples (UNDRIP)</strong></h4> <p><strong>Core Articles Relevant to Peace & Conflict Resolution</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>ILO Convention 169 - Indigenous and Tribal Peoples Convention</strong></h4> <p><strong>Relevant Provisions for Conflict Resolution</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Regional Indigenous Rights Frameworks</h3> <h4><strong>Inter-American System Indigenous Rights</strong></h4> <p><strong>Organization of American States Indigenous Rights Instruments</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>African System Indigenous Rights</strong></h4> <p><strong>African Commission on Human and Peoples’ Rights</strong>:</p> <pre class="language-undefined"><!></pre> <h3>National Indigenous Rights Legislation</h3> <h4><strong>United States Indigenous Rights Framework</strong></h4> <p><strong>Federal Indian Law and Tribal Sovereignty</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Canadian Indigenous Rights Framework</strong></h4> <p><strong>Constitutional and Legislative Protections</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>New Zealand Indigenous Rights Framework</strong></h4> <p><strong>Treaty of Waitangi and Māori Rights</strong>:</p> <pre class="language-undefined"><!></pre> <h3>International Human Rights Framework</h3> <h4><strong>Universal Declaration of Human Rights (UDHR)</strong></h4> <p><strong>Relevant Articles for Peace & Conflict Resolution</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>International Covenant on Civil and Political Rights (ICCPR)</strong></h4> <p><strong>Cultural and Political Rights Protection</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Environmental and Climate Law Framework</h3> <h4><strong>International Environmental Law</strong></h4> <p><strong>Environmental Rights and Traditional Knowledge Protection</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="cultural-authority-contacts"></a>Cultural Authority Contact Protocols</h2> <h3>Indigenous Council Networks</h3> <h4><strong>North American Indigenous Organizations</strong></h4> <p><strong>National Indigenous Representative Organizations</strong> <em>(Contact through proper protocols only)</em>:</p> <pre class="language-undefined"><!></pre> <p><strong>Regional Indigenous Organizations</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Global Indigenous Networks</strong></h4> <p><strong>International Indigenous Coordination</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Traditional Knowledge Networks</h3> <h4><strong>Traditional Knowledge Organizations</strong> <em>(Contact through appropriate cultural protocols)</em>:</h4> <pre class="language-undefined"><!></pre> <h3>Regional Cultural Authority Networks</h3> <h4><strong>Africa Traditional Authority Organizations</strong></h4> <p><strong>Ubuntu and Traditional African Governance</strong> <em>(Contact with traditional authority approval)</em>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Middle East and Islamic Authority Networks</strong></h4> <p><strong>Islamic Conflict Resolution and Traditional Authority</strong> <em>(Contact through appropriate Islamic protocols)</em>:</p> <pre class="language-undefined"><!></pre> <h4><strong>South Asian Traditional Authority Networks</strong></h4> <p><strong>Dharmic Traditions and Traditional Governance</strong> <em>(Contact with traditional authority permission)</em>:</p> <pre class="language-undefined"><!></pre> <h3>Contact Protocol Standards</h3> <h4><strong>Universal Contact Protocols for All Cultural Authorities</strong></h4> <p><strong>Respectful Engagement Requirements</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Emergency Contact Protocols</strong></h4> <p><strong>Crisis Response Cultural Authority Engagement</strong>:</p> <pre class="language-undefined"><!></pre> <h2><a id="emergency-response-resources"></a>Emergency Response Resources</h2> <h3>Crisis Response Protocols</h3> <h4><strong>Rapid Response Peace Team Activation</strong></h4> <p><strong>24-Hour Crisis Response Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Crisis Communication Protocols</strong></h4> <p><strong>Multi-Cultural Emergency Communication Standards</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Mental Health and Trauma Support</h3> <h4><strong>Culturally Appropriate Crisis Mental Health Support</strong></h4> <p><strong>Traditional Healing Integration with Crisis Support</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Community Support Networks</strong></h4> <p><strong>Traditional Support System Activation</strong>:</p> <pre class="language-undefined"><!></pre> <h3>Legal and Advocacy Support</h3> <h4><strong>Emergency Legal Protection for Cultural Authorities</strong></h4> <p><strong>Traditional Authority Protection During Crisis</strong>:</p> <pre class="language-undefined"><!></pre> <h4><strong>Crisis Advocacy and Network Mobilization</strong></h4> <p><strong>Rapid Response Advocacy Networks</strong>:</p> <pre class="language-undefined"><!></pre> <hr> <p><em>This comprehensive Reference Materials appendix provides essential resources for Peace & Conflict Resolution Framework implementation while maintaining cultural sovereignty, Traditional Knowledge protection, and authentic relationships with cultural authorities. All cultural information included with explicit permission and appropriate attribution to originating communities and traditional knowledge keepers.</em></p>',1);function yi(Un){var _n=di(),t=n(ri(_n),20),Dn=i(t);e(Dn,()=>`<code class="language-undefined">English: Tradition, Community, Sacred, Kinship, Ancestors, Ceremony, Harmony
...
Practitioner Notes: Always require traditional authority permission before invoking tradition-based interventions</code>`),o(t);var a=n(t,4),En=i(a);e(En,()=>`<code class="language-undefined">English: Power, Strength, Survival, Courage, Leadership, Honor, Victory
...
Practitioner Notes: Channel power toward community benefit rather than domination</code>`),o(a);var r=n(a,4),Mn=i(r);e(Mn,()=>`<code class="language-undefined">English: Justice, Fairness, Order, Law, Duty, Righteousness, Accountability
...
Practitioner Notes: Integrate traditional justice systems with contemporary legal frameworks</code>`),o(r);var s=n(r,4),Fn=i(s);e(Fn,()=>`<code class="language-undefined">English: Progress, Innovation, Success, Efficiency, Competition, Achievement, Development
...
Practitioner Notes: Ensure progress serves community benefit and traditional values</code>`),o(s);var l=n(s,4),xn=i(l);e(xn,()=>`<code class="language-undefined">English: Inclusion, Community, Compassion, Consensus, Equality, Empathy, Cooperation
...
Practitioner Notes: Center marginalized voices while respecting traditional authority structures</code>`),o(l);var c=n(l,4),Bn=i(c);e(Bn,()=>`<code class="language-undefined">English: Systems, Integration, Complexity, Adaptation, Flow, Networks, Emergence
...
Practitioner Notes: Honor traditional ecological knowledge as sophisticated systems thinking</code>`),o(c);var d=n(c,4),Ln=i(d);e(Ln,()=>`<code class="language-undefined">English: Holistic, Ecological, Spiritual, Interconnection, Wholeness, Planetary, Life-centered
...
Practitioner Notes: Integrate traditional ecological knowledge and ceremonial practices with consent</code>`),o(d);var u=n(d,4),Hn=i(u);e(Hn,()=>`<code class="language-undefined">English: Transformation, Evolution, Paradigm Shift, Emergence, Transcendence, Metamorphosis
...
Practitioner Notes: Support community-led transformation while maintaining cultural continuity</code>`),o(u);var g=n(u,4),Gn=i(g);e(Gn,()=>`<code class="language-undefined">English: Unity, Oneness, Integration, Wholeness, Harmony, Peace, Love
...
Practitioner Notes: Approach with humility and appropriate spiritual preparation</code>`),o(g);var p=n(g,10),zn=i(p);e(zn,()=>`<code class="language-undefined">Umuntu (Individual-in-Community): &quot;A person is a person through other persons&quot;
...
- Ceremony integration: Life force restoration and vitality ceremonies</code>`),o(p);var m=n(p,4),On=i(m);e(On,()=>`<code class="language-undefined">Conflict: &quot;Ukuphikisana&quot; (disagreement) vs. &quot;Ukugqagquzela&quot; (destructive division)
...
Peace: &quot;Ukuthula&quot; (harmony and tranquility)</code>`),o(m);var h=n(m,8),jn=i(h);e(jn,()=>`<code class="language-undefined">Taqwa (God-Consciousness): &quot;Awareness of divine presence guiding all decisions&quot;
...
- Ceremony integration: Scholarly consultation and wisdom seeking</code>`),o(h);var y=n(h,4),Wn=i(y);e(Wn,()=>`<code class="language-undefined">Conflict: &quot;Khilaf&quot; (disagreement) vs. &quot;Fitna&quot; (destructive discord)
...
Forgiveness: &quot;Maghfira&quot; (divine forgiveness) and &quot;Afw&quot; (pardoning)</code>`),o(y);var f=n(y,8),Kn=i(f);e(Kn,()=>`<code class="language-undefined">Dharma (Righteous Duty): &quot;Sacred duty maintaining cosmic and social order&quot;
...
- Anti-oppression note: Liberation for all, not just spiritual elite</code>`),o(f);var v=n(f,4),Jn=i(v);e(Jn,()=>`<code class="language-undefined">Conflict: &quot;Vivada&quot; (dispute) vs. &quot;Kalaha&quot; (destructive quarrel)
...
Liberation: &quot;Moksha&quot; (ultimate freedom) and &quot;Mukti&quot; (release from suffering)</code>`),o(v);var C=n(v,8),Vn=i(C);e(Vn,()=>`<code class="language-undefined">Ancestral Wisdom: &quot;Knowledge passed down through generations&quot;
...
- Ceremony integration: Seven generations ceremonies and future visioning</code>`),o(C);var w=n(C,4),Yn=i(w);e(Yn,()=>`<code class="language-undefined">Conflict: Community-specific terms for disagreement vs. destructive conflict
...
Balance: Traditional terms for harmony between all relations</code>`),o(w);var I=n(w,8),Qn=i(I);e(Qn,()=>`<code class="language-undefined">Tradition-Based Security:
...
- Indigenous: &quot;Community self-determination and territorial development&quot;</code>`),o(I);var T=n(I,6),Zn=i(T);e(Zn,()=>`<code class="language-undefined">Inclusion-Based Integration:
...
- Indigenous: &quot;All relations harmony and territorial wholeness&quot;</code>`),o(T);var A=n(T,6),Xn=i(A);e(Xn,()=>`<code class="language-undefined">Paradigm Shift:
...
- Indigenous: &quot;All relations harmony and territorial peace&quot;</code>`),o(A);var q=n(A,10),$n=i(q);e($n,()=>`<code class="language-undefined">Relationship Requirements:
...
- Demonstrated commitment to Indigenous sovereignty and cultural self-determination</code>`),o(q);var k=n(q,10),ne=i(k);e(ne,()=>`<code class="language-undefined">Community Election Standards:
...
- Regional Peace Hubs coordinate nomination processes while respecting local authority</code>`),o(k);var b=n(k,4),ee=i(b);e(ee,()=>`<code class="language-undefined">Core Skills Assessment:
...
- Ongoing service commitment as condition of certification maintenance</code>`),o(b);var P=n(b,6),ie=i(P);e(ie,()=>`<code class="language-undefined">Peer Review Requirements:
...
- Ongoing accountability relationship verification</code>`),o(P);var S=n(P,4),oe=i(S);e(oe,()=>`<code class="language-undefined">Advanced Skills Assessment:
...
- Innovation documentation and contribution to framework adaptation</code>`),o(S);var R=n(S,6),te=i(R);e(te,()=>`<code class="language-undefined">Traditional Authority Leadership:
...
- Contribution to framework development and cultural adaptation innovation</code>`),o(R);var _=n(R,4),ae=i(_);e(ae,()=>`<code class="language-undefined">Master Skills Assessment:
...
- Traditional authority recognition and ongoing accountability maintenance</code>`),o(_);var N=n(_,8),re=i(N);e(re,()=>`<code class="language-undefined">Cultural Authority Recognition:
...
- Cultural revitalization contribution and traditional practice strengthening</code>`),o(N);var U=n(N,6),se=i(U);e(se,()=>`<code class="language-undefined">Traditional Authority Mentorship:
...
- Sacred knowledge protection and cultural appropriation prevention</code>`),o(U);var D=n(U,8),le=i(D);e(le,()=>`<code class="language-undefined">Methodology Development:
...
- Cultural protocol and ceremonial understanding deepening</code>`),o(D);var E=n(D,4),ce=i(E);e(ce,()=>`<code class="language-undefined">Values-Based Conflict Prevention Network:
...
- Traditional governance and consensus process understanding</code>`),o(E);var M=n(E,6),de=i(M);e(de,()=>`<code class="language-undefined">Specialized Competencies:
...
- Sacred site protection and environmental ceremonial integration</code>`),o(M);var F=n(M,4),ue=i(F);e(ue,()=>`<code class="language-undefined">Specialized Competencies:
...
- Sacred knowledge protection and spiritual appropriation prevention</code>`),o(F);var x=n(F,4),ge=i(x);e(ge,()=>`<code class="language-undefined">Specialized Competencies:
...
- Technology appropriation prevention and community benefit ensuring</code>`),o(x);var B=n(x,10),pe=i(B);e(pe,()=>`<code class="language-undefined">Beck, Don Edward, and Chris C. Cowan. Spiral Dynamics: Mastering Values, Leadership and Change. 
...
- Cultural Context: Requires decolonized reading and Traditional Knowledge integration</code>`),o(B);var L=n(B,6),me=i(L);e(me,()=>`<code class="language-undefined">Fisher, Roger, William L. Ury, and Bruce Patton. Getting to Yes: Negotiating Agreement Without Giving In. 
...
- Cultural Integration: Includes traditional authority and Indigenous knowledge consideration</code>`),o(L);var H=n(L,6),he=i(H);e(he,()=>`<code class="language-undefined">Ross, Rupert. Dancing with a Ghost: Exploring Aboriginal Reality. 
...
- Implementation Note: Model for traditional authority recognition in peace processes</code>`),o(H);var G=n(H,8),ye=i(G);e(ye,()=>`<code class="language-undefined">Tutu, Desmond. No Future Without Forgiveness. 
...
- Cultural Authority Note: Reading should be supplemented with traditional authority guidance</code>`),o(G);var z=n(G,6),fe=i(z);e(fe,()=>`<code class="language-undefined">Irani, George E. &quot;Islamic Mediation Techniques for Middle East Conflicts.&quot; 
...
- Implementation Context: Model for Islamic authority integration in peace processes</code>`),o(z);var O=n(z,6),ve=i(O);e(ve,()=>`<code class="language-undefined">Nagler, Michael N. The Search for a Nonviolent Future: A Promise of Peace for Ourselves, Our Families, and Our World. 
...
- Implementation Context: Model for dharmic principles in structural conflict resolution</code>`),o(O);var j=n(O,8),Ce=i(j);e(Ce,()=>`<code class="language-undefined">Levine, Peter A. In an Unspoken Voice: How the Body Releases Trauma and Restores Goodness. 
...
- Cultural Context: Essential for understanding colonial trauma in Indigenous and communities of color</code>`),o(j);var W=n(j,6),we=i(W);e(we,()=>`<code class="language-undefined">Brave Heart, Maria Yellow Horse. &quot;The Historical Trauma Response Among Natives and Its Relationship with Substance Abuse: A Lakota Illustration.&quot; 
...
- Integration Note: Traditional support systems enhance professional trauma prevention</code>`),o(W);var K=n(W,8),Ie=i(K);e(Ie,()=>`<code class="language-undefined">Smith, Linda Tuhiwai. Decolonizing Methodologies: Research and Indigenous Peoples. 
...
- Integration Context: Feminist analysis enhanced by traditional women&#39;s knowledge systems</code>`),o(K);var J=n(K,6),Te=i(J);e(Te,()=>`<code class="language-undefined">Coulthard, Glen Sean. Red Skin, White Masks: Rejecting the Colonial Politics of Recognition. 
...
- Cultural Authority Note: Model for Indigenous community self-determination in peace processes</code>`),o(J);var V=n(J,8),Ae=i(V);e(Ae,()=>`<code class="language-undefined">Kauffman, Stuart A. At Home in the Universe: The Search for the Laws of Self-Organization and Complexity. 
...
- Traditional Knowledge Integration: Western systems theory complemented by Indigenous systems understanding</code>`),o(V);var Y=n(V,8),qe=i(Y);e(qe,()=>`<code class="language-undefined">O&#39;Neil, Cathy. Weapons of Math Destruction: How Big Data Increases Inequality and Threatens Democracy. 
New York: Crown, 2016.
...
- Implementation Context: Technology serving communities rather than extracting from them</code>`),o(Y);var Q=n(Y,6),ke=i(Q);e(ke,()=>`<code class="language-undefined">Kukutai, Tahu, and Stephanie Carroll Rainie, eds. Indigenous Data Sovereignty: Toward an Agenda. 
...
- Integration Note: Design justice principles enhanced by traditional governance systems</code>`),o(Q);var Z=n(Q,10),be=i(Z);e(be,()=>`<code class="language-undefined">Peace Framework Input Requirements:
...
- Community consent required for any intervention in traditional territories</code>`),o(Z);var X=n(Z,4),Pe=i(X);e(Pe,()=>`<code class="language-undefined">Peace Team Integration:
...
- Cultural sensitivity protocols for all GEM operations</code>`),o(X);var $=n(X,4),Se=i($);e(Se,()=>`<code class="language-undefined">Peace Dividend Allocation:
...
- Long-term sustainability and cultural strengthening prioritized</code>`),o($);var nn=n($,6),Re=i(nn);e(Re,()=>`<code class="language-undefined">Wisdom Integration Requirements:
...
- Indigenous sovereignty maintained throughout process</code>`),o(nn);var en=n(nn,4),_e=i(en);e(_e,()=>`<code class="language-undefined">Bioregional Governance Integration:
...
- Community self-determination maintained within bioregional coordination</code>`),o(en);var on=n(en,6),Ne=i(on);e(Ne,()=>`<code class="language-undefined">Cross-Framework Alignment Requirements:
...
- Long-term sustainability monitoring for integrated framework outcomes</code>`),o(on);var tn=n(on,8),Ue=i(tn);e(Ue,()=>`<code class="language-undefined">Escalation Criteria:
...
- Community healing integration with formal justice outcomes</code>`),o(tn);var an=n(tn,6),De=i(an);e(De,()=>`<code class="language-undefined">Traditional Authority Leadership:
...
- Community consent required for truth process information sharing</code>`),o(an);var rn=n(an,10),Ee=i(rn);e(Ee,()=>`<code class="language-undefined">Article 3: Right to Self-Determination
...
- Implementation: Sacred knowledge firewall and cultural appropriation prevention</code>`),o(rn);var sn=n(rn,6),Me=i(sn);e(Me,()=>`<code class="language-undefined">Article 6: Consultation and Participation
...
- Implementation: Traditional conflict resolution method honor and legal recognition</code>`),o(sn);var ln=n(sn,8),Fe=i(ln);e(Fe,()=>`<code class="language-undefined">American Declaration on the Rights of Indigenous Peoples (2016):
...
- Implementation: Traditional governance system legal recognition and protection</code>`),o(ln);var cn=n(ln,6),xe=i(cn);e(xe,()=>`<code class="language-undefined">African Charter on Human and Peoples&#39; Rights:
...
- Implementation: Community consent and traditional authority approval protocols</code>`),o(cn);var dn=n(cn,8),Be=i(dn);e(Be,()=>`<code class="language-undefined">Indian Self-Determination and Education Assistance Act (1975):
...
- Implementation: Tribal court coordination and traditional healing approaches</code>`),o(dn);var un=n(dn,6),Le=i(un);e(Le,()=>`<code class="language-undefined">Constitution Act, 1982, Section 35:
...
- Implementation: Traditional authority consultation and Indigenous jurisdiction respect</code>`),o(un);var gn=n(un,6),He=i(gn);e(He,()=>`<code class="language-undefined">Treaty of Waitangi (1840):
...
- Implementation: Iwi consultation and traditional knowledge protection</code>`),o(gn);var pn=n(gn,8),Ge=i(pn);e(Ge,()=>`<code class="language-undefined">Article 18: Freedom of Religion and Belief
...
- Implementation: Cultural authority recognition and traditional practice protection</code>`),o(pn);var mn=n(pn,6),ze=i(mn);e(ze,()=>`<code class="language-undefined">Article 27: Rights of Minorities
...
- Implementation: Community-controlled peace processes and traditional authority leadership</code>`),o(mn);var hn=n(mn,8),Oe=i(hn);e(Oe,()=>`<code class="language-undefined">Convention on Biological Diversity (CBD):
...
- Implementation: Community ownership and traditional authority control of knowledge use</code>`),o(hn);var yn=n(hn,10),je=i(yn);e(je,()=>`<code class="language-undefined">Assembly of First Nations (Canada):
...
- Application: Arctic Indigenous rights and traditional territory recognition</code>`),o(yn);var fn=n(yn,4),We=i(fn);e(We,()=>`<code class="language-undefined">Union of BC Indian Chiefs (Canada):
...
- Application: International Indigenous rights implementation and traditional authority recognition</code>`),o(fn);var vn=n(fn,6),Ke=i(vn);e(Ke,()=>`<code class="language-undefined">United Nations Permanent Forum on Indigenous Issues:
...
- Application: Traditional authority recognition and Indigenous Asian rights implementation</code>`),o(vn);var Cn=n(vn,6),Je=i(Cn);e(Je,()=>`<code class="language-undefined">International Association of Traditional Knowledge:
...
- Application: Traditional knowledge protection and community-controlled documentation</code>`),o(Cn);var wn=n(Cn,8),Ve=i(wn);e(Ve,()=>`<code class="language-undefined">Congress of Traditional Leaders of South Africa:
...
- Application: Traditional authority recognition and African cultural framework development</code>`),o(wn);var In=n(wn,6),Ye=i(In);e(Ye,()=>`<code class="language-undefined">Islamic Society of North America (ISNA):
...
- Application: Islamic conflict resolution integration and religious authority recognition</code>`),o(In);var Tn=n(In,6),Qe=i(Tn);e(Qe,()=>`<code class="language-undefined">World Hindu Congress:
...
- Application: Buddhist peace principles integration and traditional authority recognition</code>`),o(Tn);var An=n(Tn,8),Ze=i(An);e(Ze,()=>`<code class="language-undefined">Pre-Contact Research:
...
- Cultural protocol adherence and traditional calendar respect</code>`),o(An);var qn=n(An,6),Xe=i(qn);e(Xe,()=>`<code class="language-undefined">Emergency Cultural Authority Contact:
...
- Community consent verification for emergency intervention</code>`),o(qn);var kn=n(qn,10),$e=i(kn);e($e,()=>`<code class="language-undefined">Crisis Assessment Protocol:
...
- Community spiritual and ceremonial support during crisis</code>`),o(kn);var bn=n(kn,6),ni=i(bn);e(ni,()=>`<code class="language-undefined">Traditional Language Support:
...
- International Indigenous and traditional authority mutual support networks</code>`),o(bn);var Pn=n(bn,8),ei=i(Pn);e(ei,()=>`<code class="language-undefined">Traditional Healing Resources:
...
- Cultural identity strengthening and community connection for healing</code>`),o(Pn);var Sn=n(Pn,6),ii=i(Sn);e(ii,()=>`<code class="language-undefined">Community Care Networks:
...
- Cultural identity strengthening and traditional knowledge affirmation</code>`),o(Sn);var Rn=n(Sn,8),oi=i(Rn);e(oi,()=>`<code class="language-undefined">Legal Protection Resources:
...
- Cultural appropriation prevention and traditional knowledge protection</code>`),o(Rn);var Nn=n(Rn,6),ti=i(Nn);e(ti,()=>`<code class="language-undefined">Traditional Authority Support Networks:
...
- Traditional authority protection and Indigenous rights advocacy</code>`),o(Nn),li(4),si(Un,_n)}export{yi as default,ci as metadata};
