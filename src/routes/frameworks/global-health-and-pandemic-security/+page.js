...
export async function load({ depends, url, params }) {
  ...
  console.log('Loading global health & pandemic security framework sections for locale:', currentLocale);
  ...
  for (const section of sections) {
    try {
      ...
      loadedSections++;
      console.log('Successfully loaded global health & pandemic security section:', section, 'in', currentLocale);
    } catch (primaryError) {
      ...
      try {
        ...
        console.log('Loaded global health & pandemic security section:', section, 'in English as fallback');
      } catch (fallbackError) {
        console.warn(`Could not load global health & pandemic security section ${section} in any language:`, fallbackError.message);
  ...
  console.log('Total global health & pandemic security sections loaded:', loadedSections, 'out of', sections.length);
  console.log('Loaded global health & pandemic security sections:', Object.keys(content));
