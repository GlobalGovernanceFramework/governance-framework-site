...
export async function load({ depends, url, params }) {
  console.log('💰 AUBI Framework +page.js - URL pathname:', url.pathname);
  console.log('💰 AUBI Framework +page.js - Full URL:', url.href);
  ...
  console.log('Loading AUBI Framework sections for locale:', currentLocale);
