...
export async function load({ depends, url, params }) {
  console.log('🧬 Aethelred Accord +page.js - URL pathname:', url.pathname);
  console.log('🧬 Aethelred Accord +page.js - Full URL:', url.href);
  ...
  console.log('Loading Aethelred Accord sections for locale:', currentLocale);
