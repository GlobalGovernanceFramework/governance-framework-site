...
export async function load({ depends, url, params }) {
  console.log('🌍 Gaian Trade Framework +page.js - URL pathname:', url.pathname);
  console.log('🌍 Gaian Trade Framework +page.js - Full URL:', url.href);
  ...
  console.log('Loading Gaian Trade Framework sections for locale:', currentLocale);
